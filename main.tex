...
\thesistitle{Ensuring Functional Consistency Through Real-Time Comparative Testing} % Your thesis title, this is used in the title, print it elsewhere with \ttitle

%\thesissubtitle{{[}Thesis Subtitle{]}} % Your thesis title, this is used in the title, print it elsewhere with \tsubtitle

\author{Vitor \textsc{Pereira}} % Your name, this is used in the title page, print it elsewhere with \authorname
...
\advisor{Nuno \textsc{Malheiro }} % Your advisors's (academic mentor) name, this is used in the title page, print it elsewhere with \advname

\supervisor{Inês \textsc{Maia}} % Your supervisor's (company, hosting institution mentor) name, this is used in the title page, print it elsewhere with \supname (comment, if no supervisor, or same as advisor)
...
\keywords{Real-Time Testing, Production Testing, Rearchitecture Testing} % Please define up to 6 keywords that better describe your work, print it elsewhere with \keywordnames
